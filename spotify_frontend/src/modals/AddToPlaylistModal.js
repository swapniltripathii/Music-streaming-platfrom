...
const AddToPlaylistModal = ({ closeModal, addSongToPlaylist }) => {
  ...
  return (
    ...
    >
      <div
        className=" bg-app-black w-1/3 rounded-md p-5"
        onClick={(e) => {
          e.stopPropagation();
        }}
      >
...
const PlaylistListComponent = ({ info, addSongToPlaylist }) => {
  return (
    <div
      className=" bg-app-black w-full flex items-center space-x-4  hover:bg-gray-500 hover:bg-opacity-20 cursor-pointer p-2"
      onClick={() => {
